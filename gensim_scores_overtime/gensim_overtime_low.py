...
basepath = "../../trained_data/alldoctypes"
...
if __name__ == "__main__":
    ...
    print("\n\n\nSave results\n\n\n")
    with open('../../r_analyses/mediabias/gensim_overtime/output_low.json',mode='w') as fo:
        fo.write('[')
    ...
    # print(df)
    df.to_csv('../../r_analyses/mediabias/gensim_overtime/output_low.csv')
